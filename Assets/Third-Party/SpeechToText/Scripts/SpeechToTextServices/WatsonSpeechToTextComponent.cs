...
namespace UnitySpeechToText.Services
{
    ...
    public class WatsonSpeechToTextComponent
    {
        ...
        /// </summary>
        IBM.Watson.SpeechToText.V1.SpeechToTextService m_WatsonSpeechToTextService = new IBM.Watson.SpeechToText.V1.SpeechToTextService();

        /// <summary>
        /// Watson speech-to-text service
        /// </summary>
        public IBM.Watson.SpeechToText.V1.SpeechToTextService WatsonSpeechToTextService { get { return m_WatsonSpeechToTextService; } }
